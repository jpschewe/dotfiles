...
(custom-set-variables
 ...
 '(package-selected-packages
   '(applescript-mode ascii-table bash-completion cargo compat csharp-mode diminish eat elpy forge go-mode groovy-mode journalctl-mode lsp-mode magit markdown-mode osx-clipboard pandoc pandoc-mode php-mode python-mode rust-mode rustic ssh trashed yaml-mode))
