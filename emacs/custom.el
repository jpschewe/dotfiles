(custom-set-variables
 ...
 '(package-selected-packages
   '(applescript-mode ascii-table bash-completion cargo company compat csharp-mode csv-mode diminish eat elpy embark eshell-bookmark flycheck forge gnu-elpa-keyring-update go-mode groovy-mode lsp-java lsp-mode lsp-pyright magit marginalia markdown-mode osx-clipboard pandoc pandoc-mode php-mode python-mode rust-mode rustic ssh trashed use-package web-mode which-key x509-mode yaml-mode))
