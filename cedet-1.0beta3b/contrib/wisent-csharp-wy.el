...
(defconst wisent-csharp-wy--parse-table
  (progn
	...
	((USING IDENTIFIER EQ qualified_name SEMICOLON)
	 (wisent-raw-tag
	  (semantic-tag-new-include $4 nil
				    'alias $2)))
	...
	((attrs_opt modifiers_opt CONST type const_declarators SEMICOLON)
	 (wisent-raw-tag
	  (semantic-tag-new-variable $5 $4 nil
				     'const t
				     'typemodifiers $2))))
       (const_declarators
	...
	((attrs_opt modifiers_opt type variable_declarators SEMICOLON)
	 (wisent-raw-tag
	  (semantic-tag-new-variable $4 $3 nil
				     'typemodifiers $2))))
	...
	((attrs_opt modifiers_opt EVENT type qualified_name event_accessor_list)
	 (wisent-raw-tag
	  (semantic-tag-new-function $5 $4 nil
				     'typemodifiers
				     (cons "event" $2)))))
       (event_accessor_list
	((BRACE_BLOCK)
	...
	((attrs_opt modifiers_opt IDENTIFIER LPAREN RPAREN block)
	 (wisent-raw-tag
	  (semantic-tag-new-function $3 nil nil
				     'typemodifiers $2))))
       (extern_opt
	(nil)
	((EXTERN)))
	...
	((attrs_opt new_opt type IDENTIFIER formal_parameter_list SEMICOLON)
	 (wisent-raw-tag
	  (semantic-tag-new-function $4 $3 $5
				     'typemodifiers $2)))
	...
	((attrs_opt new_opt type THIS indexer_parameter_list accessor_list)
	 (wisent-raw-tag
	  (semantic-tag-new-function "this[]" $3 $5
				     'typemodifiers $2
				     'accessors $6))))
       (enum_declaration
	...
	((attrs_opt modifiers_opt ENUM IDENTIFIER enum_body)
	 (wisent-raw-tag
	  (semantic-tag-new-type $4 $3 $5 nil
				 'typemodifiers $2))))
       (enum_body
	((BRACE_BLOCK)
	 (semantic-parse-region
