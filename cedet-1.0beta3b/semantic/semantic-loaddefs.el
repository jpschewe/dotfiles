...
;;;***

;;;### (autoloads (semantic-analyze-possible-completions semantic-analyze-current-context) "semantic-analyze" "semantic/semantic-analyze.el")
...
;;;***

;;;### (autoloads (semantic-complete-analyze-inline semantic-complete-analyze-and-replace semantic-complete-jump semantic-complete-jump-local semantic-complete-inline-analyzer semantic-complete-read-tag-analyzer semantic-complete-read-tag-project semantic-complete-read-tag-buffer-deep semantic-complete-read-tag-engine) "semantic-complete" "semantic/semantic-complete.el")
...
;;;***

;;;### (autoloads (semantic-decoration-mode global-semantic-decoration-mode) "semantic-decorate-mode" "semantic/semantic-decorate-mode.el")
...
(defcustom global-semantic-decoration-mode nil "*If non-nil, enable global use of `semantic-decoration-mode'.\nWhen this mode is activated, decorations specified by\n`semantic-decoration-styles'." :group 'semantic :group 'semantic-modes :type 'boolean :require 'semantic-decorate-mode :initialize 'custom-initialize-default :set (lambda (sym val) (global-semantic-decoration-mode (if val 1 -1))))
...
;;;***

;;;### (autoloads (semantic-tag-delete-secondary-overlay semantic-tag-get-secondary-overlay semantic-tag-create-secondary-overlay semantic-tag-secondary-overlays semantic-tag-read-only-p semantic-set-tag-read-only semantic-tag-intangible-p semantic-set-tag-intangible semantic-tag-invisible-p semantic-set-tag-invisible semantic-set-tag-face semantic-momentary-highlight-tag semantic-unhighlight-tag semantic-highlight-tag) "semantic-decorate" "semantic/semantic-decorate.el")
...
;;;***

;;;### (autoloads (semantic-documentation-for-tag) "semantic-doc" "semantic/semantic-doc.el")
...
;;;***

;;;### (autoloads (semantic-edits-incremental-parser semantic-edits-flush-changes semantic-edits-change-function-handle-changes semantic-change-function) "semantic-edit" "semantic/semantic-edit.el")
...
(defsubst semantic-find-tags-included (&optional table) "Find all tags in TABLE that are of the 'include class.\nTABLE is a tag table.  See `semantic-something-to-tag-table'." (semantic-find-tags-by-class 'include table))
...
;;;***

;;;### (autoloads (semantic-format-tag-uml-concise-prototype semantic-format-tag-uml-prototype semantic-format-tag-uml-abbreviate semantic-format-tag-concise-prototype semantic-format-tag-prototype semantic-format-tag-summarize semantic-format-tag-abbreviate semantic-format-tag-name semantic-format-tag-prin1 semantic-format-tag-type) "semantic-format" "semantic/semantic-format.el")

(defvar semantic-format-tag-functions '(semantic-format-tag-name semantic-format-tag-abbreviate semantic-format-tag-summarize semantic-format-tag-prototype semantic-format-tag-concise-prototype semantic-format-tag-uml-abbreviate semantic-format-tag-uml-prototype semantic-format-tag-uml-concise-prototype semantic-format-tag-prin1) "\
...
;;;***

;;;### (autoloads (semantic-ia-complete-tip semantic-ia-complete-symbol-menu semantic-ia-complete-symbol) "semantic-ia" "semantic/semantic-ia.el")
...
;;;***

;;;### (autoloads (semantic-idle-scheduler-remove semantic-idle-scheduler-add semantic-idle-scheduler-mode global-semantic-idle-scheduler-mode) "semantic-idle" "semantic/semantic-idle.el")

(defcustom global-semantic-idle-scheduler-mode nil "*If non-nil, enable global use of idle-scheduler mode." :group 'semantic :group 'semantic-modes :type 'boolean :require 'semantic-idle :initialize 'custom-initialize-default :set (lambda (sym val) (global-semantic-idle-scheduler-mode (if val 1 -1))))
...
;;;***

;;;### (autoloads (semantic-create-imenu-index) "semantic-imenu" "semantic/semantic-imenu.el")
...
;;;***

;;;### (autoloads (define-lex-block-analyzer define-lex-simple-regex-analyzer define-lex-regex-analyzer define-lex-analyzer semantic-lex semantic-lex-init define-lex) "semantic-lex" "semantic/semantic-lex.el")
...
;;;***

;;;### (autoloads (semantic-prototype-file semantic-dependency-tag-file semantic-go-to-tag) "semantic-tag-file" "semantic/semantic-tag-file.el")
...
;;;***

;;;### (autoloads (semantic-tag-full-name semantic-tag-static-p semantic-tag-leaf-p semantic-tag-abstract-p semantic-tag-protected-p semantic-tag-protection semantic-tag-calculate-parent) "semantic-tag-ls" "semantic/semantic-tag-ls.el")
...
;;;***

;;;### (autoloads (semantic-tag-components-with-overlays semantic-tag-components) "semantic-tag" "semantic/semantic-tag.el")
...
;;;***

;;;### (autoloads (semantic-stickyfunc-mode global-semantic-stickyfunc-mode semantic-show-parser-state-mode global-semantic-show-parser-state-mode semantic-show-unmatched-syntax-mode global-semantic-show-unmatched-syntax-mode semantic-highlight-edits-mode global-semantic-highlight-edits-mode) "semantic-util-modes" "semantic/semantic-util-modes.el")
...
(defcustom global-semantic-highlight-edits-mode nil "*If non-nil enable global use of variable `semantic-highlight-edits-mode'.\nWhen this mode is enabled, changes made to a buffer are highlighted\nuntil the buffer is reparsed." :group 'semantic :group 'semantic-modes :type 'boolean :require 'semantic-util-modes :initialize 'custom-initialize-default :set (lambda (sym val) (global-semantic-highlight-edits-mode (if val 1 -1))))
...
(defcustom global-semantic-show-unmatched-syntax-mode nil "*If non-nil, enable global use of `semantic-show-unmatched-syntax-mode'.\nWhen this mode is enabled, syntax in the current buffer which the\nsemantic parser cannot match is highlighted with a red underline." :group 'semantic :group 'semantic-modes :type 'boolean :require 'semantic-util-modes :initialize 'custom-initialize-default :set (lambda (sym val) (global-semantic-show-unmatched-syntax-mode (if val 1 -1))))
...
(defcustom global-semantic-show-parser-state-mode nil "*If non-nil enable global use of `semantic-show-parser-state-mode'.\nWhen enabled, the current parse state of the current buffer is displayed\nin the mode line. See `semantic-show-parser-state-marker' for details\non what is displayed." :group 'semantic :type 'boolean :require 'semantic-util-modes :initialize 'custom-initialize-default :set (lambda (sym val) (global-semantic-show-parser-state-mode (if val 1 -1))))
...
(defcustom global-semantic-stickyfunc-mode nil "*If non-nil, enable global use of `semantic-stickyfunc-mode'.\nThis minor mode only works for Emacs 21 or later.\nWhen enabled, the header line is enabled, and the first line\nof the current function or method is displayed in it.\nThis makes it appear that the first line of that tag is\n`sticky' to the top of the window." :group 'semantic :group 'semantic-modes :type 'boolean :require 'semantic-util-modes :initialize 'custom-initialize-default :set (lambda (sym val) (global-semantic-stickyfunc-mode (if val 1 -1))))
...
;;;***

;;;### (autoloads (semantic-bovinate-toplevel semantic-fetch-tags semantic-parse-region-default) "semantic" "semantic/semantic.el")
...
;;;***

;;;### (autoloads (semanticdb-find-tags-external-children-of-type semanticdb-brute-find-tags-by-class semanticdb-brute-deep-find-tags-by-name semanticdb-deep-find-tags-for-completion semanticdb-deep-find-tags-by-name-regexp semanticdb-deep-find-tags-by-name semanticdb-find-tags-by-class semanticdb-find-tags-for-completion semanticdb-find-tags-by-name-regexp semanticdb-find-tags-by-name semanticdb-find-tags-collector semanticdb-find-table-for-include) "semanticdb-find" "semantic/semanticdb-find.el")
...
;;;***

;;;### (autoloads (semanticdb-load-system-caches semanticdb-create-system-database) "semanticdb-system" "semantic/semanticdb-system.el")

(defcustom semanticdb-default-system-save-directory (expand-file-name "~/.semanticdb") "*Directory name where semantic cache files for system headers are stored.\nSystem files cannot have caches stored near them because users rarely have\nwrite permission to such paths." :group 'semanticdb :type '(choice :tag "System-Save-Directory" :menu-tag "System-Save-Directory" (const :tag "Use current directory" :value nil) (directory)))
...
;;;***

;;;### (autoloads (semanticdb-file-stream semanticdb-file-table-object global-semanticdb-minor-mode semanticdb-minor-mode-p) "semanticdb" "semantic/semanticdb.el")

(defcustom semanticdb-global-mode nil "*If non-nil enable the use of `semanticdb-minor-mode'." :group 'semantic :type 'boolean :require 'semanticdb :initialize 'custom-initialize-default :set (lambda (sym val) (global-semanticdb-minor-mode (if val 1 -1)) (custom-set-default sym val)))
...
(add-hook 'java-mode-hook (function wisent-java-default-setup))
...
(add-hook 'python-mode-hook (function wisent-python-default-setup))
